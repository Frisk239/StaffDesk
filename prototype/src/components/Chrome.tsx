...
import { SCENARIOS, SCENARIO_HINTS } from '../scenario';
import type { ObjectKind, ScenarioKind, View } from '../types';
  ...
  return (
    <div className="chat-topbar">
      ...
      <div className="action-cluster">
        <button type="button" className="btn outline sm" onClick={() => dispatch({ type: 'TOAST', text: '成品才跑' })}>
          调研
        </button>
        <button type="button" className="btn outline sm" onClick={() => dispatch({ type: 'TOAST', text: '成品才有' })}>
          回放
        </button>
        <button
          type="button"
